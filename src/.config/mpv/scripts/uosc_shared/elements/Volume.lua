...
function MuteButton:new(props)
  return Class.new(self, "volume_mute", props) --[[@as MuteButton]]
end
function MuteButton:get_visibility()
  return Elements.volume:get_visibility(self)
end
function MuteButton:on_mbtn_left_down()
...
function VolumeSlider:on_global_mbtn_left_up()
  self.pressed = false
end
function VolumeSlider:on_global_mouse_leave()
  self.pressed = false
end
...
function VolumeSlider:on_wheel_up()
  self:set_volume(state.volume + options.volume_step)
end
function VolumeSlider:on_wheel_down()
  self:set_volume(state.volume - options.volume_step)
end
...
function Volume:update_dimensions()
  ...
  local max_y = (controls and controls.enabled and controls.ay)
    or (timeline.enabled and timeline.ay)
