...
function Controls:get_visibility()
  return (Elements.speed and Elements.speed.dragging) and 1
    or Elements.timeline:get_is_hovered() and -1
...
function Controls:update_dimensions()
  ...
  if Elements.timeline.enabled then
    available_space = available_space - Elements.timeline.size_max
  end
