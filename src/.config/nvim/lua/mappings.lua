...
function M.lspconfig(client, bufnr)
  ...
  buf_k("n", m.definition, "<cmd>Lspsaga goto_definition<CR>")
  ...
  buf_k("n", m.goto_prev_diagnostics, "<cmd>Lspsaga diagnostic_jump_prev ++quiet<CR>")
  buf_k("n", m.goto_prev_error_diagnostics, function()
    require("lspsaga.diagnostic"):goto_prev({ severity = vim.diagnostic.severity.ERROR })
  end)

  buf_k("n", m.goto_next_diagnostics, "<cmd>Lspsaga diagnostic_jump_next ++quiet<CR>")
